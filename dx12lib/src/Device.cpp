...
class DX12LIB_API MakeGUI : public GUI
{
public:
...
class DX12LIB_API MakeUnorderedAccessView : public UnorderedAccessView
{
public:
...
class DX12LIB_API MakeShaderResourceView : public ShaderResourceView
{
public:
...
class DX12LIB_API MakeConstantBufferView : public ConstantBufferView
{
public:
...
class DX12LIB_API MakePipelineStateObject : public PipelineStateObject
{
public:
...
class DX12LIB_API MakeRootSignature : public RootSignature
{
public:
...
class DX12LIB_API MakeTexture : public Texture
{
public:
...
class DX12LIB_API MakeStructuredBuffer : public StructuredBuffer
{
public:
...
class DX12LIB_API MakeVertexBuffer : public VertexBuffer
{
public:
...
class DX12LIB_API MakeIndexBuffer : public IndexBuffer
{
public:
...
class DX12LIB_API MakeConstantBuffer : public ConstantBuffer
{
public:
...
class DX12LIB_API MakeByteAddressBuffer : public ByteAddressBuffer
{
public:
...
class DX12LIB_API MakeDescriptorAllocator : public DescriptorAllocator
{
public:
...
class DX12LIB_API MakeSwapChain : public SwapChain
{
public:
...
class DX12LIB_API MakeCommandQueue : public CommandQueue
{
public:
...
class DX12LIB_API MakeDevice : public Device
{
public:
