...
class DX12LIB_API MakeUploadBuffer : public UploadBuffer
{
public:
...
#if 0
std::shared_ptr<SceneNode> CommandList::CreateSceneNode(const VertexCollection& vertices, const IndexCollection& indices, UINT color)
{
    if (vertices.empty())
    {
        return nullptr;
